(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Planning/casino.gtd" "~/Planning/innovita.gtd" "~/Planning/maybe.gtd" "~/Projects/python/market/market.gtd" "~/Planning/journal.gtd" "~/Planning/gtd.gtd")))
